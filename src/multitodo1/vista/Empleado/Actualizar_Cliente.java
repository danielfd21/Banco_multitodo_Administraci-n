...
public class Actualizar_Cliente extends javax.swing.JDialog {
    ...
    multitodo1.modelo.Empleado nue_emp = new multitodo1.modelo.Empleado();

    public static String ce;
    /**
     * Creates new form Crear_Cliente
     */
    public Actualizar_Cliente(java.awt.Frame parent, boolean modal, String ced) {
        super(parent, modal);
        initComponents();
        this.ce = ced;
        nue_emp.Insertar_Datos_Cliente(jced, jnom, jape, jcor, jdfec, ce);
    }
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        multitodo1.modelo.Cliente Act_cli = new multitodo1.modelo.Cliente(jced, jnom, jape, jcor, jdfec);
        
    String id =   Act_cli.Actualizar_Cliente(ce);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Actualizar_Cliente dialog = new Actualizar_Cliente(new javax.swing.JFrame(), true, ce);
